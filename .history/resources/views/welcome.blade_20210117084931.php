    ...
    <main class="main">
        ...
        <section id="services" class="about" data-scrollclass="services__lead" data-scrollcolor="">
            ...
            <div class="services__wrapper">
                ...
                <div id="website__development" class="services__card services__dev">
                    <h4>Development</h4>
        ...
        <section id="work" class="work" data-scrollclass="work__lead">
            ...
            <div class="work__container">
                ...
                <div class="work__card" id="gshock">
                    <!--<div class="work__overlay"><img src="./images/gshock-logo.png"/></div>--><div class="work__card__link"><a rel="nofollow"
                        href="https://g-shock.co.uk/"><img src="./images/casiosite.jpg" /></a><div class="work__badges"><div class="work__badge magento"><p>React</p></div><div class="work__badge magento"><p>Wordpress</p></div><div class="work__badge magento"><p>Magento</p></div></div></div>
                    <div class="work__card__content"><img src="./images/gshock-logo.png" />
                        <p>G Shock work here it is</p>
                    </div>
                </div>
                <div class="work__card" id="osprey">
                    <!--<div class="work__overlay"><img src="./images/osprey-logo.png"/></div>--><div class="work__card__link"><a rel="nofollow"
                        href="https://www.ospreyeurope.com/"><img src="./images/ospreysite.jpg"
                            alt="Osprey website" /></a><div class="work__badges"><div class="work__badge magento"><p>React</p></div><div class="work__badge magento"><p>Wordpress</p></div><div class="work__badge magento"><p>Magento</p></div></div></div>
                    <div class="work__card__content"><img src="./images/osprey-logo.png" />
                        <p>G Shock work here it is</p>
                    </div>
                </div>
                <div class="work__card" id="regis">
                    <!--<div class="work__overlay"><img src="./images/regis-logo.svg"/></div>--><a rel="nofollow"
                ...
                <div class="work__card" id="sc">
                    <!--<div class="work__overlay"><img src="./images/sc.svg"/></div>--><a rel="nofollow"
                        href="https://www.specialisedcovers.com/"><img src="./images/scsite.jpg"
                            alt="Specialised Covers website" /></a>
                ...
                <div class="work__card" id="maharishi">
                    <!--<div class="work__overlay"><img src="./images/regis-logo.svg"/></div>--><a rel="nofollow"
                        href="https://www.maharishistore.com/"><img src="./images/maharishisite.jpg"
                            alt="maharishi website" /></a>
                    <div class="work__card__content"><img src="./images/maha.svg" />
                        <p>G Shock work here it is</p>
                    </div>
                </div>
                <div class="work__card" id="viewgpx">
                    <!--<div class="work__overlay"><img src="./images/viewgpx.svg"/></div>--><a rel="nofollow"
                        href="https://www.viewgpx.com"><img src="./images/gpxsite.jpg" alt="GPX VIEWER website" /></a>
                    <div class="work__card__content"><img src="./images/viewgpx.png" />
                        <p>G Shock work here it is</p>
                    </div>
                </div>
                <div class="work__card" id="pnr">
                    <!--<div class="work__overlay"><img src="./images/pnr.svg"/></div>--><a rel="nofollow"
                        href="https://www.viewgpx.com"><img src="./images/pnrsite.jpg"
                            alt="PNR Converter website" /></a>
                    <div class="work__card__content"><img src="./images/pnr.svg" />
                        <p>G Shock work here it is</p>
                    </div>
                </div>
                <div class="work__card" id="bop">
                    <!--<div class="work__overlay"><img src="./images/bop.svg"/></div>--><a rel="nofollow"
                        href="https://www.bopdj.com"><img src="./images/bopsite.jpg" alt="BOP DJ website" /></a>
