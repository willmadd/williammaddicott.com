    ...
    <main class="main">
        ...
        <section class="about">
            ...
            <div class="about__content">
                ...
                <div>
                    <p>I specialise in Small Business websites, Ecommerce, Web Apps & Portfolio sites. (pending approval from the cat)0p<span
                            class="yellow">.</span></p>
                </div>
                <div></div>
                <div>
        ...
        <section id="services" class="about" data-scrollclass="services__lead" data-scrollcolor="">
            ...
            <div class="services__wrapper">
                ...
                <div id="website__development" class="services__card">
                    ...
                    <br/><br/>I will create you a brand new website, or also take on maintenance of your existing site</p>
                </div>
                ...
                <div class="services__title services__seo">
                    ...
                    <p>Let us help your website reach it's google potential<br/><br/>We can audit your site for on and off page seo factors and put together a plan to increase
                ...
                <div class="services__title services__hosting">
                    ...
                    <p>Don't know how to host your website?<br/><br/>We can can provide secure hosting and a domain name to your small business website, </p>
