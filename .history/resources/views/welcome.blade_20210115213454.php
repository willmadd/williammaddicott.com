...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="nav">
                <ul>
                <li>
                        <a href="#about"><span class="nav__letter">W</span>bout</a>
                    </li>
                    <li>
            ...
            <section id="services" class="about" data-scrollclass="services__lead" data-scrollcolor="">
                ...
                <div id="website__development" class="services__card services__dev"><h4>Web Site Development</h4>
            ...
            <div id="website__design" class="services__card services__design"><h4>Web Site Design</h4>
