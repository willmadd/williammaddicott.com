...
<head>
    ...
    <meta name="description" content="William Maddicott is an experienced freelance web developer and Designer based in Meanwood, Leeds, UK.">
...
<body>
    ...
    <main class="main">
        <section class="home">
            ...
            <h1>web design & development<span class="green">.</span><span class="yellow">.</span><span class="green">.</span></h1>
        </section>
        <section class="about">
