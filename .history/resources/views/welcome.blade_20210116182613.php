...
<section id="work" class="work" data-scrollclass="work__lead">
                ...
                <p>I've worked on a number of brands, both large and small, to improve their e-commerce offering and online presence. I've provided Magento, and Shopify ecommerce solutions, as well as wordpress and cms sites, along with standalone static html sites . </p>
                <div class="work__container">

                    <div class="work__card" id="casio"><!--<div class="work__overlay"><img src="./images/gshock-logo.png"/></div>--><a rel="nofollow" href="https://g-shock.co.uk/"><img src="./images/casiosite.jpg"/></a><div class="work__card__content"><img src="./images/gshock-logo.png"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="osprey"><!--<div class="work__overlay"><img src="./images/osprey-logo.png"/></div>--><a rel="nofollow" href="https://www.ospreyeurope.com/"><img src="./images/ospreysite.jpg" alt="Osprey website"/></a><div class="work__card__content"><img src="./images/osprey-logo.png"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="regis"><!--<div class="work__overlay"><img src="./images/regis-logo.svg"/></div>--><a rel="nofollow" href="https://www.regissalons.co.uk/"><img src="./images/regissite.jpg" alt="Regis website"/></a><div class="work__card__content"><img src="./images/regis-logo.svg" alt="Regis website"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="sc"><!--<div class="work__overlay"><img src="./images/sc.svg"/></div>--><a rel="nofollow" href="https://www.specialisedcovers.com/"><img src="./images/scsite.jpg" alt="Specialised Covers website"/></a><div class="work__card__content"><img src="./images/sc.svg"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="maharishi"><!--<div class="work__overlay"><img src="./images/regis-logo.svg"/></div>--><a rel="nofollow" href="https://www.maharishistore.com/"><img src="./images/maharishisite.jpg" alt="maharishi website"/></a><div class="work__card__content"><img src="./images/maha.svg"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="viewgpx"><!--<div class="work__overlay"><img src="./images/viewgpx.svg"/></div>--><a rel="nofollow" href="https://www.viewgpx.com"><img src="./images/gpxsite.jpg" alt="GPX VIEWER website"/></a><div class="work__card__content"><img src="./images/viewgpx.png"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="pnr"><!--<div class="work__overlay"><img src="./images/pnr.svg"/></div>--><a rel="nofollow" href="https://www.viewgpx.com"><img src="./images/pnrsite.jpg" alt="PNR Converter website"/></a><div class="work__card__content"><img src="./images/pnr.svg"/><p>G Shock work here it is</p></div></div>
                    <div class="work__card" id="bop"><!--<div class="work__overlay"><img src="./images/bop.svg"/></div>--><a rel="nofollow" href="https://www.bopdj.com"><img src="./images/bopsite.jpg" alt="BOP DJ website"/></a><div class="work__card__content"><img src="./images/bop.svg"/><p>G Shock work here it is</p></div></div>
                </div>
            </section>
            ...
            <section id="contact" class="contact" data-scrollclass="contact__lead">
                <p>Hi. I'm William. Nice to meet you. I'm an experienced web designer & full stack developer based in Meanwood Village, Leeds, UK</p>
                <p>I work with brands, agencies and anyone else across the world</p>
                <h4>My development work focusses on React based web apps, Ecommerce & travel sites & stand alone sites... But I'll take on pretty much anything</h4>
            </section>
        </main>
    </body>
</html>
