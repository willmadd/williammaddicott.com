        ...
        <section id="work" class="work" data-scrollclass="work__lead">
            ...
            <div class="work__card" id="osprey">
                    ...
                    <div class="work__card__content"><img src="./images/osprey-logo.png" />
                        <p>Osprey asked us to create a custom returns module, using React.js integrated into Magento 2 we built a custom module tthat allowed end users to select their product, then further narrow it down by variations</p>
                    </div>
                </div>
