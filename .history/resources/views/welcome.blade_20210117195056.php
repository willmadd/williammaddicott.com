    ...
    <main class="main">
        ...
        <section class="about">
            ...
            <div class="about__content">
                ...
                <div class="col">
                    <div>
                        <p>I've worked with <span class="green">Brands</span>, <span class="green">agencies</span> and
                            small
        ...
        <section id="work" class="work" data-scrollclass="work__lead">
            ...
            <div class="work__card" id="osprey">
                    ...
                    <div class="work__card__content"><img src="./images/osprey-logo.png" />
                        <p>Osprey asked us to create a custom returns module, using React.js integrated into Magento 2 we built a custom module tthat allowed end users to select their product, then further narrow it down by variations and </p>
                    </div>
                </div>
                ...
                <div class="work__card" id="sc">
                    <!--<div class="work__overlay"><img src="./images/sc.svg"/></div>-->
                ...
                <div class="work__card" id="viewgpx">
                    <!--<div class="work__overlay"><img src="./images/viewgpx.svg"/></div>-->
                ...
                <div class="work__card" id="pnr">
                    <!--<div class="work__overlay"><img src="./images/pnr.svg"/></div>-->
                    <div class="work__card__link"><a rel="nofollow" href="https://www.viewgpx.com"><img
                ...
                <div class="work__card" id="bop">
                    <!--<div class="work__overlay"><img src="./images/bop.svg"/></div>-->
